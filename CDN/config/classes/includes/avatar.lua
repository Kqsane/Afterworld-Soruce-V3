-- ALL OF THE SCRIPTS WERE REUTILIZATED FROM ROVIVE.
local userId, baseurl = %userid%, "%url%"
print("Renderin user" .. userId)
pcall(function() game:GetService("ContentProvider"):SetBaseUrl("http://www." .. baseurl) end)
...
plr.CharacterAppearance = "http://www." .. baseurl .. "/Asset/characterfetch.ashx?UserID="..userId
