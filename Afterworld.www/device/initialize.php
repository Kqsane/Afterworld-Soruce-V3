...
header("server: envoy");
header("set-cookie: RBXAppDeviceIdentifier=AppDeviceIdentifier=null; domain=aftwld.xyz; path=/");
header("strict-transport-security: max-age=3600");
header("x-envoy-upstream-service-time: 3");
header("x-roblox-region: us-central");
header("x-roblox-edge: sjc1");
header('report-to: {"group":"network-errors","max_age":604800,"endpoints":[{"url":"https://ncs.aftwld.xyz/upload"}]}');
