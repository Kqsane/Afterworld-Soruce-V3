...
$(function(){
    function trackReturns() {
		...
		<div id="ErrorPage">
		<h1><span id="ctl00_cphRoblox_ErrorTitle">Even though we have the same avatar.</span></h1>
		<img src="/Chloe/Avatar.png" id="ctl00_cphRoblox_ErrorImage" alt="Alert" class="ErrorAlert" style="height: 200px; width: 200px;">
		<h1><span id="ctl00_cphRoblox_ErrorTitle"></span></h1>
		<h3><span id="ctl00_cphRoblox_ErrorMessage">And we both are named Chloe</span></h3>
		<h3><span id="ctl00_cphRoblox_ErrorMessage">Im Not Her....</span></h3>
		<p><span id="ctl00_cphRoblox_CustomerServiceMessage">anyway i work here unpaid :3</span></p>
