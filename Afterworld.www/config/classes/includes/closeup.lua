-- ALL THE SCRIPTS WERE REUTILIZATED FROM ROVIVE
x = 748
y = 748
...
local baseurl = "https://www.rb14.us.to" -- correct url
pcall(function() game:GetService("ContentProvider"):SetBaseUrl(baseurl) end)
characterAppearanceUrl = "http://www.rb14.us.to/asset/CharacterFetch.ashx?userId="..userId
