...
<title>Afterworld - Badges</title>
<link rel='stylesheet' href='/CSS/Base/CSS/main___3cf17678f5d36ad2b9b72dd3439177be_m.css' />
<link rel='stylesheet' href='/CSS/Base/CSS/page___05956118b64d3204e25b40c8c47d9c88_m.css' />
...
<?php
include_once $_SERVER['DOCUMENT_ROOT'] . '/config/badges.php';

$badgesByCategory = [];
foreach ($badgeMap as $id => $badge) {
    $cat = $badge['cat'];
    if (!isset($badgesByCategory[$cat])) {
        $badgesByCategory[$cat] = [];
    }
    $badgesByCategory[$cat][$id] = $badge;
}
?>
                                ...
                                <div class="BadgeCategory">
                                    ...
                                    <ul>
                                        <?php foreach ($badges as $id => $badge): ?>
                                            <li id="Badge<?= $id ?>" class="divider-bottom">
                                                <div class="BadgePadding">&nbsp;</div>
                                                <div class="BadgeContent">
                                                    <div class="BadgeImage">
                                                        <img src="<?= htmlspecialchars($badge['img']) ?>" alt="<?= htmlspecialchars($badge['name']) ?>" width="75" height="75" />
                                                    </div>
                                                    <div class="BadgeDescription">
                                                        <h3><?= htmlspecialchars($badge['name']) ?> Badge</h3>
                                                        <p class="notranslate"><?= htmlspecialchars($badge['desc']) ?></p>
                                                    </div>
...
<div id="PlaceLauncherStatusPanel" style="display:none;width:300px"
    ...
    <div class="modalPopup blueAndWhite PlaceLauncherModal" style="min-height: 160px">
        <div id="Spinner" class="Spinner" style="padding:20px 0;">
            <img src="/images/Badges/e998fb4c03e8c2e30792f2f3436e9416.gif" height="32" width="32" alt="Progress" />
        </div>
    ...
    <div class="modalPopup ph-modal-popup">
        ...
        <div class="ph-areyouinstalleddialog-content">
            ...
            <div class="ph-startingdialog-spinner-row">
                <img src="/images/Badges/4bed93c91f909002b1f17f05c0ce13d1.gif" width="82" height="24" />
            </div>
        </div>
    </div>
</div>
...
<div id="ProtocolHandlerClickAlwaysAllowed" class="ph-clickalwaysallowed" style="display:none;">
    <p class="larger-font-size">
        ...
        Check <b>Remember my choice</b> and click <img src="/images/Badges/7c8d7a39b4335931221857cca2b5430b.png" alt="Launch Application" />  in the dialog box above to join games faster in the future!
    </p>
</div>
    ...
    <div style="min-height: 275px; background-color: white;">
        ...
        <div class="RevisedFooter" >
            <div style="width:200px;margin:10px auto 0 auto;">
                <a href="/?returnUrl=%2FBadges.aspx"><div class="RevisedCharacterSelectSignup"></div></a>
                <a class="HaveAccount" href="/newlogin?returnUrl=%2FBadges.aspx">I have an account</a>
            </div>
        </div>
    </div>
</div>
