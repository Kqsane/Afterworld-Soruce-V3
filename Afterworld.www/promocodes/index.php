...
<h1><span>Redeem AFTERWORLD Promotions</span></h1>
<div id="RedeemContainer">
    <div id="Instructions">
        <div class="header">How to Use</div>
        <div class="listitem">Have you received a AFTERWORLD promotional code from one of our many events or give-aways?</div>
    ...
    <div style="float:left;">
        ...
        <div class="ResultContainer">
            <div id="success" class="ResultSuccessBox"><img src="http://images.rbxcdn.com/6acd50d6f06cb4801309f2334d6728ab.png" alt="Success" /><span id="SuccessMessage" class="ResultBoxTextAligned">Redeemed Successfully</span></div>
            <div id="error" class="ResultErrorBox"><img src="http://images.rbxcdn.com/6fde87e250e2921967a1de2e878449ef.png" alt="Failure" /><span id="errorText" class="ResultBoxTextAligned">Expired or Invalid Promocode</span></div>
        </div>
    </div>
</div>
...
<div id="Footer" class="footer-container">
    <div class="FooterNav">
        ...
        &nbsp;|&nbsp;
        <a href="/home" class="roblox-interstitial">Press</a>
        &nbsp;|&nbsp;
        <a href="http://corp.aftwld.xyz/contact-us" class="roblox-interstitial">Contact Us</a>
        &nbsp;|&nbsp;
        <a href="/home" class="roblox-interstitial">About Us</a>
        &nbsp;|&nbsp;
        <a href="http://blog.aftwld.xyz" class="roblox-interstitial">Blog</a>
        &nbsp;|&nbsp;
        <a href="/home" class="roblox-interstitial">Jobs</a>
        &nbsp;|&nbsp;
        <a href="/home" class="roblox-interstitial">Parents</a>
    </div>
</div>
        </div>
        <div class="right">
            <p class="Legalese">
    ROBLOX, "Online Building Toy", characters, logos, names, and all related indicia are trademarks of <a href="http://aftwld.xyz/" ref="footer-smallabout" class="roblox-interstitial">ROBLOX Corporation</a>, ©2015. Patents pending.
...
<script type='text/javascript' src='http://js.rbxcdn.com/f1364fca59e2f679232656d1b13991ba.js'></script>
...
<script type='text/javascript' src='http://js.rbxcdn.com/e3a913253f6cb8d64dc84ed62f8d02a7.js'></script>
...
<img id="jynxziBounce" src="https://jynxzimerchs.com/wp-content/uploads/2023/07/Jynxzi-Merch-1.jpg" alt="Jynxzi Bouncing">
...
(function() {
    ...
    const img = document.getElementById("jynxziBounce");

    document.addEventListener("keydown", function(e) {
        keys[e.key.toLowerCase()] = true;

        if (keys["j"] && keys["z"] && !bounceActive) {
            bounceActive = true;
...
<video id="hgVideo" src="https://files.catbox.moe/o2v931.mp4" autoplay loop></video>
<div id="hgFlashbang"></div>
