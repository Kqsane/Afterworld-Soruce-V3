...
<link rel='stylesheet' href='/CSS/Base/CSS/page___52ecb4339a49a1b9212e1c6894fd0ca0_m.css' />
...
<script type='text/javascript'>window.Sys || document.write("<script type='text/javascript' src='/js/Microsoft/MicrosoftAjax.js'><\/script>")</script>
    ...
    <script type='text/javascript' src='http://js.rbxcdn.com/0392919e76186a11f81ea25aa97bf5b7.js.gzip'></script>

    <script type='text/javascript' src='http://js.rbxcdn.com/56323c0f48e307896413a398ca63f18c.js.gzip'></script>
...
<script type='text/javascript' src='/rbxcdn_js/6385cae49dc708a8f2f93167ad17466d.js'></script>
    ...
    <script type='text/javascript' src='http://js.rbxcdn.com/77026e0e8875389783edcd7224c6e72b.js.gzip'></script>
...
<script type="text/javascript">
    ...
    Roblox.UpsellAdModal.Resources = {
        ...
        <script type="text/javascript">
            Roblox.XsrfToken.setToken('ARgoTWFpLYuH');
        </script>
        <script type="text/javascript">
    ...
    <script type="text/javascript">
        ...
        <script>
            ...
            <div id="EventStreamData"
             data-default-url="//ecsv2.aftwld.xyz/www/e.png"
             data-www-url="//ecsv2.aftwld.xyz/www/e.png"
             data-studio-url="//ecsv2.aftwld.xyz/pe?t=studio"></div>

    <script type="text/javascript">
if (typeof(Roblox) === "undefined") { Roblox = {}; }
Roblox.Endpoints = Roblox.Endpoints || {};
Roblox.Endpoints.Urls = Roblox.Endpoints.Urls || {};
Roblox.Endpoints.Urls['/asset/'] = 'http://assetgame.aftwld.xyz/asset/';
Roblox.Endpoints.Urls['/client-status/set'] = 'http://aftwld.xyz/client-status/set';
Roblox.Endpoints.Urls['/client-status'] = 'http://aftwld.xyz/client-status';
Roblox.Endpoints.Urls['/game/'] = 'http://assetgame.aftwld.xyz/game/';
Roblox.Endpoints.Urls['/game/edit.ashx'] = 'http://assetgame.aftwld.xyz/game/edit.ashx';
Roblox.Endpoints.Urls['/game/getauthticket'] = 'http://assetgame.aftwld.xyz/game/getauthticket';
Roblox.Endpoints.Urls['/game/placelauncher.ashx'] = 'http://assetgame.aftwld.xyz/game/placelauncher.ashx';
Roblox.Endpoints.Urls['/game/report-stats'] = 'http://assetgame.aftwld.xyz/game/report-stats';
Roblox.Endpoints.Urls['/game/report-event'] = 'http://assetgame.aftwld.xyz/game/report-event';
Roblox.Endpoints.Urls['/chat/chat'] = 'http://misc.aftwld.xyz/chat/chat';
Roblox.Endpoints.Urls['/presence/users'] = 'http://aftwld.xyz/presence/users';
Roblox.Endpoints.Urls['/presence/user'] = 'http://aftwld.xyz/presence/user';
Roblox.Endpoints.Urls['/friends/list'] = 'http://aftwld.xyz/friends/list';
Roblox.Endpoints.Urls['/navigation/getCount'] = 'http://aftwld.xyz/navigation/getCount';
Roblox.Endpoints.Urls['/catalog/browse.aspx'] = 'http://aftwld.xyz/catalog/browse.aspx';
Roblox.Endpoints.Urls['/catalog/html'] = 'http://search.aftwld.xyz/catalog/html';
Roblox.Endpoints.Urls['/catalog/json'] = 'http://search.aftwld.xyz/catalog/json';
Roblox.Endpoints.Urls['/catalog/contents'] = 'http://search.aftwld.xyz/catalog/contents';
Roblox.Endpoints.Urls['/catalog/lists.aspx'] = 'http://search.aftwld.xyz/catalog/lists.aspx';
Roblox.Endpoints.Urls['/asset-hash-thumbnail/image'] = 'http://assetgame.aftwld.xyz/asset-hash-thumbnail/image';
Roblox.Endpoints.Urls['/asset-hash-thumbnail/json'] = 'http://assetgame.aftwld.xyz/asset-hash-thumbnail/json';
Roblox.Endpoints.Urls['/asset-thumbnail-3d/json'] = 'http://assetgame.aftwld.xyz/asset-thumbnail-3d/json';
Roblox.Endpoints.Urls['/asset-thumbnail/image'] = 'http://assetgame.aftwld.xyz/asset-thumbnail/image';
Roblox.Endpoints.Urls['/asset-thumbnail/json'] = 'http://assetgame.aftwld.xyz/asset-thumbnail/json';
Roblox.Endpoints.Urls['/asset-thumbnail/url'] = 'http://assetgame.aftwld.xyz/asset-thumbnail/url';
Roblox.Endpoints.Urls['/asset/request-thumbnail-fix'] = 'http://assetgame.aftwld.xyz/asset/request-thumbnail-fix';
Roblox.Endpoints.Urls['/avatar-thumbnail-3d/json'] = 'http://aftwld.xyz/avatar-thumbnail-3d/json';
Roblox.Endpoints.Urls['/avatar-thumbnail/image'] = 'http://aftwld.xyz/avatar-thumbnail/image';
Roblox.Endpoints.Urls['/avatar-thumbnail/json'] = 'http://aftwld.xyz/avatar-thumbnail/json';
Roblox.Endpoints.Urls['/avatar-thumbnails'] = 'http://aftwld.xyz/avatar-thumbnails';
Roblox.Endpoints.Urls['/avatar/request-thumbnail-fix'] = 'http://aftwld.xyz/avatar/request-thumbnail-fix';
Roblox.Endpoints.Urls['/bust-thumbnail/json'] = 'http://aftwld.xyz/bust-thumbnail/json';
Roblox.Endpoints.Urls['/group-thumbnails'] = 'http://aftwld.xyz/group-thumbnails';
Roblox.Endpoints.Urls['/groups/getprimarygroupinfo.ashx'] = 'http://aftwld.xyz/groups/getprimarygroupinfo.ashx';
Roblox.Endpoints.Urls['/headshot-thumbnail/json'] = 'http://aftwld.xyz/headshot-thumbnail/json';
Roblox.Endpoints.Urls['/item-thumbnails'] = 'http://aftwld.xyz/item-thumbnails';
Roblox.Endpoints.Urls['/outfit-thumbnail/json'] = 'http://aftwld.xyz/outfit-thumbnail/json';
Roblox.Endpoints.Urls['/place-thumbnails'] = 'http://aftwld.xyz/place-thumbnails';
Roblox.Endpoints.Urls['/thumbnail/asset/'] = 'http://aftwld.xyz/thumbnail/asset/';
Roblox.Endpoints.Urls['/thumbnail/avatar-headshot'] = 'http://aftwld.xyz/thumbnail/avatar-headshot';
Roblox.Endpoints.Urls['/thumbnail/avatar-headshots'] = 'http://aftwld.xyz/thumbnail/avatar-headshots';
Roblox.Endpoints.Urls['/thumbnail/user-avatar'] = 'http://aftwld.xyz/thumbnail/user-avatar';
Roblox.Endpoints.Urls['/thumbnail/resolve-hash'] = 'http://aftwld.xyz/thumbnail/resolve-hash';
Roblox.Endpoints.Urls['/thumbnail/place'] = 'http://aftwld.xyz/thumbnail/place';
Roblox.Endpoints.Urls['/thumbnail/get-asset-media'] = 'http://aftwld.xyz/thumbnail/get-asset-media';
Roblox.Endpoints.Urls['/thumbnail/remove-asset-media'] = 'http://aftwld.xyz/thumbnail/remove-asset-media';
Roblox.Endpoints.Urls['/thumbnail/set-asset-media-sort-order'] = 'http://aftwld.xyz/thumbnail/set-asset-media-sort-order';
Roblox.Endpoints.Urls['/thumbnail/place-thumbnails'] = 'http://aftwld.xyz/thumbnail/place-thumbnails';
Roblox.Endpoints.Urls['/thumbnail/place-thumbnails-partial'] = 'http://aftwld.xyz/thumbnail/place-thumbnails-partial';
Roblox.Endpoints.Urls['/thumbnail_holder/g'] = 'http://aftwld.xyz/thumbnail_holder/g';
Roblox.Endpoints.Urls['/users/{id}/profile'] = 'http://aftwld.xyz/users/{id}/profile';
...
Roblox.Endpoints = Roblox.Endpoints || {};
Roblox.Endpoints.Urls = Roblox.Endpoints.Urls || {};
Roblox.Endpoints.Urls['/authentication/is-logged-in'] = 'http://aftwld.xyz/authentication/is-logged-in';
</script>
...
<script type="text/javascript">
    ...
    var _user_id = '62402235';

    // IMPORTANT! Set to a unique session ID for the visitor's current browsing session.
    var _session_id = '62402235';
...
<div class="modalPopup unifiedModal smallModal shop-modal shop-modal-item" data-modal-handle="shop-confirmation" style="display: none;">
    ...
    <div class="shop-modal-item-left">
        ...
        <div class="fine-print">
            The shop is not part of aftwld.xyz and is governed by a separate <a href="http://www.myplay.com/direct/cookie-policy?origin=desktop&permalink=shoproblox">privacy policy</a>.
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    Roblox.messageDefaults = {
        ...
        robloxUserThumbnail: "http://t7.rbxcdn.com/92e02c789262eb4efb2c6222695f1b78",
        robloxUserAbsoluteUrl: "http://aftwld.xyz/users/1/profile/"
    };
    </script>
...
<div id="Footer" class="footer-container">
    <div class="FooterNav">
        <a href="http://aftwld.xyz/info/Privacy.aspx">Privacy Policy</a>
        &nbsp;|&nbsp;
...
&nbsp;|&nbsp;        <a href="http://blog.aftwld.xyz">Blog</a>
        &nbsp;|&nbsp;
...
&nbsp;|&nbsp;        <a href="http://corp.aftwld.xyz/parents" class="roblox-interstitial">Parents</a>
    ...
    Use of this site signifies your acceptance of the <a href="http://aftwld.xyz/info/terms-of-service" ref="footer-terms">Terms and Conditions</a>.
</p>
            </div>
        <div class="clear"></div>
    </div>
...
<div id="usernotifications-data-model"
     class="hidden"
     data-notificationsdomain="https://notifications.aftwld.xyz/"
    ...
    <script type="text/javascript">
        ...
        Roblox.Chat = {
            SoundFile: "http://aftwld.xyz/Chat/sound/chatsound.mp3"
        };
        Roblox.Party = {};
...
<div id="chat-data-model"
     ...
     data-domain="aftwld.xyz"
     data-gamespagelink="http://aftwld.xyz/games"
     data-chatdomain="https://chat.aftwld.xyz"
...
<div id="ProtocolHandlerClickAlwaysAllowed" class="ph-clickalwaysallowed" style="display:none;">
    ...
    <div id="videoPrerollPanel" style="display:none">
        ...
        <div id="videoPrerollJoinBC">
            ...
            <a href="https://aftwld.xyz/premium/membership?ctx=preroll" target="_blank" class="btn-medium btn-primary" id="videoPrerollJoinBCButton">Join Builders Club</a>
        </div>
    </div>   
    ...
    <div style="min-height: 275px; background-color: white;">
        ...
        <div class="RevisedFooter">
            <div style="width:200px;margin:10px auto 0 auto;">
                <a href="http://aftwld.xyz/?returnUrl=http%3A%2F%2Faftwld.xyz%2Fmy%2Fmessages%2F"><div class="RevisedCharacterSelectSignup"></div></a>
                <a class="HaveAccount" href="https://aftwld.xyz/newlogin?returnUrl=http%3A%2F%2Faftwld.xyz%2Fmy%2Fmessages%2F">I have an account</a>
            </div>
        </div>
    </div>
</div>
...
<div class="ConfirmationModal modalPopup unifiedModal smallModal" data-modal-handle="confirmation" style="display:none;">
    ...
    <script type="text/javascript">
        $(function () {
            Roblox.CookieUpgrader.domain = 'aftwld.xyz';
